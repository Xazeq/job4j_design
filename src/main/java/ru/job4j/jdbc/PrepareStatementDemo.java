...
public class PrepareStatementDemo {
    ...
    public static void main(String[] args) throws Exception {
        PrepareStatementDemo statement = new PrepareStatementDemo();
        //statement.insert(new City(2, "Tver", 370_000));
        //statement.update(new City(2, "Tver", 425_000));
        //statement.delete(5);
        List<City> list = statement.findAll();
        //list.forEach(System.out::println);
        for (var city : list) {
            System.out.println(city);
        }

        //City city = statement.insert(new City(12, "St. Peterburg", 9000000));
        //System.out.println(city);
    }
}
